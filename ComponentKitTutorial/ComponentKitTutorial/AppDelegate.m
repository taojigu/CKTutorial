//
//  AppDelegate.m
//  ComponentKitTutorial
//
//  Created by Gu on 2017/9/7.
...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    tabControl.viewControllers = [self mainViewControllers];
...
-(NSArray*)mainViewControllers
{
    ...
    StartViewController* startVC = [[StartViewController alloc]initWithCollectionViewLayout:flowLayout];
